//import { RequestHandler } from './APIRequests/RequestHandler'
import { Link } from 'react-router-dom'
//import { MainWraper } from './mainWraper.tsx'
import './pagination.css'
import { useState } from 'react';

/*добавить активную страницу*/

export function Pagination (args: { serchResult: { results: [], count: number, next:string } }) {
