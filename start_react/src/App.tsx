...
class App extends Component {
    ...
    render() {
        ...
        <div className='root_wraper'>
            ...
            <div className="search_wraper">
                ...
                <button className="search_btn error_btn" onClick={handleError}>Throw an error</button>
            </div >
            <SearchWraper 
    ...
    changeIsAPIRequest = (target:boolean) => this.setState({
        isGetAPIRequest: target
    })
    LoadingOpenClose = (state:boolean) => {
        return state? "": <div className='loading'><PacmanLoader color={'#36D7B7'} size={150} /> </div>
    }
